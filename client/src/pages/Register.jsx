...
const Register = () => {
  ...
  useEffect(() => {
    const isEmailValid =
      inputs.email.trim() !== "" && validateEmail(inputs.email);
    const isValid =
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
                  <svg
                    className="h-5 w-5 text-gray-400 group-focus-within:text-[#3fcd9d] transition-colors"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
                ...
                <input
                  ...
                  className={`w-full p-4 border rounded-xl focus:outline-none focus:ring-3 focus:ring-[#84eac6]/30 transition-all duration-200 bg-white/70 backdrop-blur-sm group-hover:border-gray-300 ${
                    emailError
                      ...
                      : "border-gray-200 focus:border-[#3fcd9d]"
                  }`}
                />
                <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
                  <svg
                    className={`h-5 w-5 transition-colors ${
                      emailError
                        ? "text-red-400"
                        : "text-gray-400 group-focus-within:text-[#3fcd9d]"
                    }`}
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
              ...
              {inputs.password && (
                <div className="mt-2 space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`text-xs font-semibold ${passwordStrength.color} font-body`}
                    >
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <label
                  htmlFor="terms"
                  className="text-sm text-gray-700 font-body leading-relaxed"
                >
                  I agree to the{" "}
                  <button
                    type="button"
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[80vh] overflow-hidden">
            ...
            <div className="p-6 overflow-y-auto max-h-[60vh] font-body">
              <div className="prose prose-sm max-w-none text-gray-600">
                ...
                <p className="mb-4">
                  Users must not post content that is illegal, harmful,
